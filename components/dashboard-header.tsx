      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <Select value={selectedRegion} onValueChange={setSelectedRegion} disabled={selectedArea === "all-areas"}>
          ...
          <SelectContent>
            ...
            {selectedArea === "all-areas" ? (
              <>
                <SelectItem value="sumbagut">SUMBAGUT</SelectItem>
                <SelectItem value="sumbagteng">SUMBAGTENG</SelectItem>
                <SelectItem value="sumbagsel">SUMBAGSEL</SelectItem>
                <SelectItem value="jabar">JABAR</SelectItem>
                <SelectItem value="eastern-jabotabek">EASTERN JABOTABEK</SelectItem>
                <SelectItem value="central-jabotabek">CENTRAL JABOTABEK</SelectItem>
                <SelectItem value="western-jabotabek">WESTERN JABOTABEK</SelectItem>
                <SelectItem value="balinusra">BALINUSRA</SelectItem>
                <SelectItem value="jatim">JATIM</SelectItem>
                <SelectItem value="jateng">JATENG</SelectItem>
