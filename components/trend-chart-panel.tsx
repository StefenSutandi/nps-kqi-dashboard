      ...
      <CardContent>
        <div className="h-80 flex items-center justify-center">
          <svg viewBox="0 0 800 300" className="w-full h-full">
            ...
            {/* X-axis labels - update dengan tanggal real */}
            ...
            {/* TikTok Kalimantan - Green (improving) */}
            <polyline
              fill="none"
              stroke="#10b981"
              strokeWidth="2"
            ...
            {/* Update legend dengan area yang real */}
